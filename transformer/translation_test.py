...
if __name__ == "__main__":
    ...
    argparser.add_argument("--gpu", default=0, help="gpu id")
    argparser.add_argument("--N", default=4, type=int, help="num of layers")
    argparser.add_argument("--dataset", default="multi30k", help="dataset")
    # argparser.add_argument("--dataset", default="copy", help="dataset")
    ...
    fpred = open("pred.txt", "w", encoding="utf-8")
    fref = open("ref.txt", "w", encoding="utf-8")
